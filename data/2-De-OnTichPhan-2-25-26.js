window.EXAM_DATA = {
    ...
    "questions": [
        ...
        },
        {
            ...
            "ans": 0,
            "explain": "Ta có $x^2 - 2x=0 \\Leftrightarrow x=0$ hoặc $x=2$.<br> Bảng xét dấu <img src=\"https://raw.githubusercontent.com/Nguyenbm1979/Trac-nghiem-nguyen-ham/main/images/img_1767749056531_121.png\" style=\"max-width:100%;margin-top:10px;border-radius:5px\"> $I= \\displaystyle \\int\\limits_{-1}^{2} \\left|x^2 - 2x\\right| \\mathrm{d}x$<br>$ = \\displaystyle \\int\\limits_{-1}^{0} \\left(x^2 - 2x\\right) \\mathrm{d}x - \\displaystyle \\int\\limits_{0}^{2} \\left(x^2 - 2x\\right) \\mathrm{d}x$<br>$ = \\left(\\dfrac{x^3}{3} - x^2\\right)\\bigg|_{-1}^0 - \\left(\\dfrac{x^3}{3} - x^2\\right)\\bigg|_{0}^2$ <br> $ = \\left[0 - \\left(-\\dfrac{1}{3}-1\\right)\\right] - \\left[\\left(\\dfrac{8}{3}-4\\right)-0\\right] = \\dfrac{8}{3}. $",
            "id": "2D4H2-5"
        },
        {
            "type": "mcq",
