window.EXAM_DATA = {
    ...
    "questions": [
        ...
        },
        {
            ...
            "ans": 2,
            "explain": "Phương trình mặt phẳng $(P)$ song song với $(\\alpha)$ có dạng $4x+3y-12z+c=0$. Mặt cầu $(S)$ có tâm $I(1;2;3)$, bán kính $r=4$ nên $(P)$ tiếp xúc với $(S)$ khi và chỉ khi $ 4= d\\left( I,(P) \\right)=\\dfrac{\\left| c-26 \\right|}{13}\\Leftrightarrow \\left[\\begin{aligned}&c=78\\\\&c=-26.\\end{aligned}\\right. $ Vậy có hai mặt phẳng thỏa mãn bài toán là $4x+3y-12z+78=0$, $4x+2y-12z-26=0$.",
            "id": "2H3B2-3",
            "point": 0.25
        },
        {
        ...
        },
        {
            ...
            "ans": 3,
            "explain": "Vì $(P)$ đi qua $O$ nên phương trình mặt phẳng $(P)$ có dạng $ax+by+cz=0$ ($a^2+b^2+c^2>0$). Vì $A\\in (P)$ và $B$, $C$ cách đều $(P)$ nên $ \\left\\{\\begin{aligned}&-a-2b=0\\\\&\\left| 4b \\right|=\\left| 3c \\right|\\end{aligned}\\right. $.<br> Chọn $a=-6$, ta có $b=3$, suy ra $c=\\pm 4$. Vậy có hai mặt phẳng thỏa mãn là $-6x+3y-4z=0$ hoặc $-6x+3y+4z=0$.",
            "id": "2H3K2-3",
            "point": 0.25
        },
        {
