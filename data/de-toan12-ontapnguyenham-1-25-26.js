window.EXAM_DATA = {
  ...
  },
  {
    ...
    "ans": "54{,}4",
    "explain": "Ta có $h(t)=\\displaystyle\\int v(t) \\mathrm{\\,d}t=\\displaystyle\\int \\left(-0{,}1t^3+t^2\\right) \\mathrm{\\,d}t=-\\dfrac{1}{40}{t^4}+\\dfrac{t^3}{3}+C$.\\\\\nCây cà chua khi trồng có chiều cao $5$ cm nên $h(0)=5\\Rightarrow C=5$.\\\\\nVậy độ cao của cây cà chua ở tuần thứ $t$ được cho bởi hàm số\\\\ \n\\centerline {$h(t)=-\\dfrac{1}{40}{t^4}+\\dfrac{t^3}{3}+5$ $(t\\ge 0)$.}\\\\\nTa tìm $ t$ $(t\\ge 0)$ sao cho $v(t)$ đạt giá trị lớn nhất.\\\\\n$v'(t)=-0{,}3t^2+2t$; $ v'(t)=0\\Leftrightarrow-0{,}3t^2+2t=0\\Leftrightarrow\\left[\begin{aligned}&t=0\\\\&t=\\dfrac{20}{3}.\end{aligned}\right.$\\\\\n Ta lập bảng biến thiên.Từ đó ta thấy $v(t)$ đạt giá trị lớn nhất tại $t=\\dfrac{20}{3}$.\\\\\nKhi đó, cây cà chua sẽ đạt chiều cao là $h\\left(\\dfrac{20}{3}\\right)=\\dfrac{4\\,405}{81}\\approx 54{,}4$ (cm)."
  }
    ]
};
