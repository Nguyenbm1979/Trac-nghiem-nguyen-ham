window.EXAM_DATA = {
    ...
    "questions": [
        ...
        {
            "type": "mcq",
            "q": "Thời gian trung bình sử dụng ChatGPT trên một ngày của một nhóm học sinh được ghi lại trong bảng dưới đây:<br><img src=\"https://raw.githubusercontent.com/Nguyenbm1979/Trac-nghiem-nguyen-ham/main/images/img_1767765194395_950.png\" style=\"max-width:100%;margin:10px 0;border-radius:5px\"><br>Chọn ngẫu nhiên một bạn học sinh trong nhóm trên. Tính xác suất để thời gian trung bình bạn đó sử dụng Chat GPT lớn hơn hoặc bằng $25$ phút một ngày (làm tròn kết quả đến hàng phần trăm).",
            "options": [
                "$0{,}50$",
                "$0{,}38$",
                "$0{,}37$",
        ...
        {
            "type": "mcq",
            "q": "Thời gian trung bình sử dụng ChatGPT trên một ngày của một nhóm học sinh được ghi lại trong bảng dưới đây:<br><img src=\"https://raw.githubusercontent.com/Nguyenbm1979/Trac-nghiem-nguyen-ham/main/images/img_1767765210516_209.png\" style=\"max-width:100%;margin:10px 0;border-radius:5px\"><br>Do sai sót trong quá trình nhập và xử lý số liệu, tất cả các mốc thời gian trong bảng trên đã bị ghi lùi $5$ phút so với thực tế và người ta điều chỉnh lại bảng số liệu ban đầu cho đúng. Gọi $s_1, s_2$ lần lượt là độ lệch chuẩn của mẫu số liệu ghép nhóm trước và sau khi chỉnh sửa. Chọn khẳng định đúng nhất.",
            "options": [
                "$s_1 = s_2$",
                "$s_1 > s_2$",
                "$s_1 < s_2$",
        ...
        {
            "type": "match",
            "q": "Cho hàm số $y=f(x)$ xác định và có bảng biến thiên trên $[-2;4]$ như sau:<br><img src=\"https://raw.githubusercontent.com/Nguyenbm1979/Trac-nghiem-nguyen-ham/main/images/img_1767765222539_405.png\" style=\"max-width:100%;margin:10px 0;border-radius:5px\">",
            "items": [
        ...
        {
            "type": "match",
            "q": "Cho hàm số $y=f(x)$, với $f(x)$ là đa thức bậc bốn, có đồ thị hàm số $y=f'(x)$ như hình vẽ.<br>Đặt $g(x)=f\\left(-x^2+3x-m\\right)$.<br><img src=\"https://raw.githubusercontent.com/Nguyenbm1979/Trac-nghiem-nguyen-ham/main/images/img_1767765254897_874.png\" style=\"max-width:100%;margin:10px 0;border-radius:5px\">",
            "items": [
